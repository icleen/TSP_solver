...
namespace NetworkRouting
{
    public partial class Form1 : Form
    {
        ...
        // Use this to generate paths (from start) to every node; then, 
        // just return the path of interest from start node to end node
        ...
        private double arraySpeed = -1;
        private double heapSpeed = -1;
        ...
        private void paintStartStopPoints()
        {
            ...
            {
                Graphics graphics = Graphics.FromImage(pictureBox.Image);
                graphics.DrawEllipse(new Pen(Color.Green, 6), points[startNodeIndex].X, 
                                     points[startNodeIndex].Y, 1, 1);
                this.graphics = graphics;
                pictureBox.Invalidate();
            }
            ...
            {
                Graphics graphics = Graphics.FromImage(pictureBox.Image);
                graphics.DrawEllipse(new Pen(Color.Red, 2), points[stopNodeIndex].X - 3, 
                                     points[stopNodeIndex].Y - 3, 8, 8);
                this.graphics = graphics;
                pictureBox.Invalidate();
            }
        }
